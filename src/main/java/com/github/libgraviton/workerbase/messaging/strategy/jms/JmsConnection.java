...
/**
 * Represents a connection to a queue of a JMS compatible queue system. In case of a queue com.github.libgraviton.workerbase.messaging.exception, the connection
...
public class JmsConnection extends QueueConnection {
     ...
     */
    protected JmsConnection(com.github.libgraviton.workerbase.messaging.strategy.jms.JmsConnection.Builder builder) {
        super(builder);
    ...
    protected void openConnection() throws CannotConnectToQueue {
        try {
            ...
            connection.setExceptionListener(new com.github.libgraviton.workerbase.messaging.strategy.jms.RecoveringExceptionListener(this));
    ...
    public static class Builder<JmsBuilder extends Builder> extends QueueConnection.Builder<JmsBuilder> {
        ...
        @Override
        public com.github.libgraviton.workerbase.messaging.strategy.jms.JmsConnection build() throws CannotBuildConnection {
            return new com.github.libgraviton.workerbase.messaging.strategy.jms.JmsConnection(this);
        }
    }
}
